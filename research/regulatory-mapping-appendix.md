...
| Record-keeping and logging | Art. 12 | Meta-framework §9 (audit chain), EPG §A.12, ROC §A.4, MDR §3.1 | Strong | Tamper-evident, version-stamped audit records with full chain composition across components. GIL provides interaction-level traceability. |
