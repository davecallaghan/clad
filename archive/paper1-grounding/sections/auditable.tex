...
it should be checked directly, and Section~\ref{sec:structured} argues such claims
...
estimated against an answer key, offline, on questions whose answers are already
