...
conceptual and architectural book. The failure shapes it describes are drawn from
...
program reporting a grounding rate should report the protocol and its error properties
...
treated as an institutional artifact. Real authority is issue-specific,
...
this book prevents that; tier assignment is exactly where a governance regime is
...
\paragraph{Generalization beyond the systems in scope is unaddressed.}
