...
\begin{itemize}
  ...
  \item \texttt{$\textbackslash\{\}Permitted$(clinical\_\allowbreak{}terminology)} --- enterprise has considered clinical terminology and imposes no restriction
\end{itemize}
...
\begin{itemize}
  ...
  \item \texttt{$\textbackslash\{\}Permitted$(investment\_\allowbreak{}thesis\_\allowbreak{}language)} --- the department has considered investment thesis language and does not restrict it for professional audiences
