...
distribution, task operationalisation, prompt representation, model version, and serving
configuration. Every empirical validation regime generalises from finite samples under
...
generalisation that broad consequential reliance requires is unavailable --- not because
